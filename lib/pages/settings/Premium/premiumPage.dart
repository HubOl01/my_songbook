...
import '../../../components/premListTitle.dart';
            ...
            child: Column(
              children: [
                ...
                const PremListTitle(
                  title: "Без рекламы",
                  subtitle:
                      "Полностью погрузитесь в творчество без отвлекающих баннеров и видеорекламы.",
                ),
                const PremListTitle(
                  title: "Неограниченные возможности",
                  subtitle:
                      "Создавайте столько групп песен, сколько нужно, и настраивайте их под себя — изменяйте цвета, порядок, ищите нужное и экспортируйте.",
                ),
                const PremListTitle(
                  title: "Ранний доступ к новым функциям",
                  subtitle:
                      "Владельцы полной версии всегда первыми получают обновления и улучшения.",
                ),
                const PremListTitle(
                  title: "Удобство и простота",
                  subtitle:
                      "Интуитивный интерфейс для быстрого создания и управления вашими песнями.",
                ),
...
// 🎶 My Songbook Pro — ваш надежный помощник в мире музыки. Превратите идеи в шедевры уже сегодня!'''),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(15),
                      border: Border.all(
                          color: colorFiolet.withValues(alpha: .5),
                          width: 1.5)),
                  child: Column(
                    children: [
                      const Text(
                ...
                SizedBox(
                  ...
                  child: CustomButton(
                    ...
                    child:
                        const Text("Приобрести полную версию за 149 ₽ в год"),
                  ),
                ),
                const SizedBox(
                  height: 10,
