  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        После подписки вам станут доступны некоторые функции, такие как неограниченное создание групп, изменение цвета групп и т.д. В дальнейшем мы планируем добавить новые функции.'''),
            const SizedBox(
              height: 20,
            ),
            SizedBox(
