...
class CodegenLoader extends AssetLoader{
  ...
  "confirmation_content_export_song": "导出已成功完成并保存在songs_export的downloads文件夹中。zip存档。\n\n要共享数据吗？",
  "confirmation_content_export_group1": "导出已成功完成并保存在",
  "confirmation_content_export_group2": "_export的downloads文件夹中。zip存档。\n\n要共享数据吗？",
  ...
  "search": "曲目，艺术家",
  "data_export": "导出数据",
  "data_importTitle": "添加单个歌曲或组",
  "data_importSongs": "导入歌曲数据",
  "data_importGroup": "导入组数据",
  "data_backup": "创建备份副本",
  "data_restore": "从备份还原",
  "data_export_import_title": "进出口",
  "confirmation_group_title_select": "选择一个组",
  "title_new_group": "为新组命名",
  "title_search_group": "组的名称",
  ...
  "confirmation_import_contentSong2": ". 确认后，所选歌曲将被添加到数据库中，系统将重新启动。\n\n要导入吗？",
  "confirmation_import_contentGroup2": ". 确认后，选定的组将被添加到数据库中，系统将重新启动。\n\n要导入吗？",
  "error_duplicate_group_title": "重复组",
  "error_duplicate_group_message": "具有该名称的乐队已经存在。",
  "group_export_content1": "小组",
  "group_export_content2": "成功导出。 分享档案？",
  "group_export_title": "该组已经存在",
  "group_export_content2_2": "已经存在",
  "group_export_title_success": "出口已完成",
  "group_warring_content": "注意！ 只有在缺少类似歌曲时才添加组，否则将跳过该歌曲。",
  "add_song_group_btn": "将歌曲添加到现有组",
  "add_new_group_btn": "创建一个新组",
  "export_group_btn": "导出组",
  ...
  "change_the_order": "更改订单",
  "exit_title_dialog": "出口；出口",
  "exit_content_dialog": "您确定要退出应用程序吗？",
  "exit_dialog_cancel": "取消",
  "exit_dialog_exit": "出口；出口",
  "settings_exit": "确认退出",
  "no_data": "没有可用的数据",
...
static const Map<String,dynamic> _ru = {
  ...
  "edit_song_name_singer": "Автор/Исполнитель: ",
  "confirmation_title": "Подтверждение",
  "confirmation_content_export_song": "Экспорт успешно выполнен и сохранен в папке downloads в архиве songs_export.zip.\n\nЖелаете ли вы поделиться данными?",
  "confirmation_content_export_group1": "Экспорт успешно выполнен и сохранен в папке downloads в архиве ",
  "confirmation_content_export_group2": "_export.zip.\n\nЖелаете ли вы поделиться данными?",
  ...
  "add_song_label_name_singer": "Автор/Исполнитель",
  ...
  "search": "Трек, автор/исполнитель",
  "data_export": "Экспорт данных",
  "data_importTitle": "Добавление отдельных песен или групп",
  "data_importSongs": "Импорт данных песен",
  "data_importGroup": "Импорт данных группы",
  ...
  "title_search_group": "Название группы",
  ...
  "confirmation_import_contentSong2": ". После подтверждения выбранные песни будут добавлены в базу данных и система будет перезапущена.\n\nЖелаете ли вы выполнить импорт?",
  "confirmation_import_contentGroup2": ". После подтверждения выбранная группа будет добавлена в базу данных и система будет перезапущена.\n\nЖелаете ли вы выполнить импорт?",
  "error_duplicate_group_title": "Повторяющаяся группа",
  "error_duplicate_group_message": "Группа с таким названием уже существует.",
  "group_export_content1": "Группа",
  "group_export_content2": "успешно экспортирована. Поделиться архивом?",
  "group_export_title": "Группа уже существует",
  "group_export_title_success": "Экспорт завершён",
  "group_export_content2_2": "уже существует",
  "group_warring_content": "Внимание! В группу добавляется только в том случае, если отсутствует похожая песня, в противном случае песня будет пропущена.",
  "add_song_group_btn": "Добавить песни в существующую группу",
  "add_new_group_btn": "Создать новую группу",
  "export_group_btn": "Экспортировать группу",
  ...
  "title_group": "Группа",
  "title_groups": "Группы",
  "starred_app": "Оцените приложение",
  "change_the_order": "Изменить порядок",
  "exit_title_dialog": "Выход",
  "exit_content_dialog": "Вы уверены, что хотите выйти из приложения?",
  "exit_dialog_cancel": "Отмена",
  "exit_dialog_exit": "Выйти",
  "settings_exit": "Подтверждение выхода",
  "no_data": "Нет данных",
